...
import plastic1 from '../../assets/images/plastic1.jpg';
import software1 from '../../assets/images/sofware1.jpg';

import { Link, useNavigate } from 'react-router-dom';
import { Facebook, Instagram, Linkedin, Menu, Twitter, User, X } from 'lucide-react';
import { useDispatch, useSelector } from 'react-redux';
import { logoutuser } from '@/Store/AuthSlice/AuthSlice';
import { getallexpo } from '@/Store/AttendeeSlice/AttendeeExpoSlice';
    ...
    <>
      ...
      <div className="relative w-full h-[600px] overflow-hidden">
        ...
        <div className="absolute inset-0 bg-black bg-opacity-50  flex flex-col justify-center items-center text-white">
          ...
          <p className="text-lg md:text-xl mb-6">
            Explore the latest events, services, and more!
          </p>

          {
            !isAuthenticated && (
              <div className="flex gap-4">
                <button>
                  <Link to={"/exhibitorauth/register"} className="bg-pink-500 hover:bg-pink-600 text-white font-semibold py-2 px-6 rounded-md">
                    Become Exhibitor
                  </Link>
                </button>
                <button>
                  <Link to={"/attendeeauth/register"} className="bg-white text-pink-500 hover:text-pink-600 font-semibold py-2 px-6 rounded-md border border-pink-500">
                    Become Attendee
                  </Link>
                </button>
              </div>
      ...
      <div className='mt-12'>
        <h1 className='text-5xl font-semibold text-center'>
          <Link to={"/attendee/attendeeevents"}>Show All</Link>
        </h1>
      </div>
